...
function getEnnemie(multiplicateur) {
    // console.log(`La rarity ${randomRarity}`);
    var tab = [];
    ...
    // console.log("=========== fin randomPlayer ========");
    console.log("On multiplie les hp ennemie de ".concat(multiplicateur));
    return {
        name: tab[randomEnnemies].name,
        hp: tab[randomEnnemies].hp * multiplicateur,
        str: tab[randomEnnemies].str * multiplicateur,
        maxHp: tab[randomEnnemies].hp * multiplicateur,
    };
}
